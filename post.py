...
def generatePost(stdscr):
    ...
    stdscr.addstr(7, 0, '¿Desea guardar el archivo? (S/N):')
    stdscr.refresh()
    respuesta = stdscr.getstr(8, 0).decode()

    if respuesta.lower() == 's':
        stdscr.addstr(10, 0, 'Nombre del archivo de salida (.md):')
        stdscr.refresh()
        archivo_salida = stdscr.getstr(11, 0).decode()
        ...
        stdscr.addstr(13, 0, '¡Post publicado con éxito!')
        stdscr.refresh()
